<h2><a href="https://www.geeksforgeeks.org/problems/mother-vertex/1?page=1&category=Graph,DFS,BFS&sortBy=submissions">Mother Vertex</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a Directed Graph, find a Mother Vertex in the Graph (<strong>if present</strong>).&nbsp;<br>A Mother Vertex is a vertex through which we can reach all the other vertices of the Graph.</span></p>
